...
void G_InitCvars( void ) {
	...
	g_specialMoveSpatialTolerance = gi.cvar( "g_specialMoveSpatialTolerance", "1.5", CVAR_ARCHIVE );
	g_specialMoveTemporalTolerance = gi.cvar( "g_specialMoveTemporalTolerance", "3", CVAR_ARCHIVE );
