...
cp docs/ssao-sp.md docs/irradiance-probes.md "$package/"
...
cp docs/passcode-overlay.md "$package/"
...
cp docs/steam-audio-sp.md docs/audio-audit.md docs/audio-routing.md "$package/"
