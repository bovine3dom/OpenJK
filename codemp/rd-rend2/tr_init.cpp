...
void R_Register( void )
{
	...
	r_sss = ri.Cvar_Get("r_sss", "0", CVAR_ARCHIVE, "Skin diffusion strength; values above 1 exaggerate the correction.");
	...
	r_capsuleShadowWalls = ri.Cvar_Get("r_capsuleShadowWalls", "0", CVAR_ARCHIVE, "Orient capsule proximity occlusion to receiver normals, including walls.");
	...
	ri.Cvar_CheckRange(r_sssRadius, 0, 8, qfalse);
	ri.Cvar_CheckRange(r_sssDebug, 0, 5, qtrue);
	ri.Cvar_CheckRange(r_sssDebugGain, 1, 128, qfalse);
